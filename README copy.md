...
Replace `Kodp` with your github ID, and replace `<Number>` with the chapter ID.

Notice: `<Number>` is chosen from `[1,2,3,4,5,6,7,8]`

```bash
# 
$ git clone git@github.com:LearningOS/2025s-rcore-Kodp
$ cd 2025s-rcore-Kodp
...
```bash
# Replace Kodp with your github ID 
$ git clone git@github.com:LearningOS/2025s-rcore-Kodp
$ cd 2025s-rcore-Kodp
$ rm -rf ci-user
